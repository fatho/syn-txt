...
impl Note {
    ...
    /// ```
    /// use syn_txt::*;
    /// assert_eq!(Note::named(NoteName::A, NoteOffset::Base, 4), Some(Note(69)));
    /// assert_eq!(Note::named(NoteName::A, NoteOffset::Base, 4), Some(Note(69)));
    /// assert_eq!(Note::named(NoteName::C, NoteOffset::Sharp, 6), Some(Note(85)));
    /// assert_eq!(Note::named(NoteName::G, NoteOffset::Flat, 2), Some(Note(42)));
    /// ```
